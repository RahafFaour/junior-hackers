        ...
        <Container fluid="xs">
          <Row>
            <Col>
              ...
              >
                <a style={{ marginLeft: 15 }}>
                  +51 84 612495 | +51 84 612603 | +51 984119405 |<br></br>{" "}
                  <a style={{ marginLeft: 26 }}>+51 993876434</a>
                </a>
              </Icon>
              <br></br>
              <Icon
                ...
                name="mail"
              >
                <a style={{ marginLeft: 10 }} href="mailto:info@pachachaca.org">
                  info@pachachaca.org
                </a>
              </Icon>
            </Col>
            <Col>
              ...
              >
                <a style={{ marginLeft: 20 }}>
                  Bergweg 209b, 3037 EJ Rotterdam
                </a>
              </Icon>
              <br></br>
              <Icon
              ...
              >
                <a
                  style={{ marginLeft: 10 }}
                  href="mailto:yoreemfoundation@gmail.com"
                >
                  yoreemfoundation@gmail.com
                </a>
              </Icon>
            </Col>
            <Col>
              ...
              >
                <a style={{ marginLeft: 15 }}>
                  We want to thank our donors and partners for making
                  <a style={{ marginLeft: 30 }}> Pachachaca possible</a>
                </a>
                <br></br>
                <Icon
                  style={{ display: "inline" }}
